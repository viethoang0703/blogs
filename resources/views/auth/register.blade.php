          ...
          <form class="form-signin" method="post" action="{{ url('auth/register') }}">
           {!! csrf_field() !!}
            ...
            <div class="form-group">
                ...
                <input type="text" id="inputName" class="form-control" name="name" value="{{ old('name') }}" placeholder="Tài khoản" required autofocus>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="inputPassword" class="sr-only">Xác nhận mật khẩu</label>
                <input type="password" id="inputPassword" class="form-control" name="password_confirmation" placeholder="Xác nhận mật khẩu" required>
            </div>
