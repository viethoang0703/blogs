...
class NewsTableSeeder extends Seeder {
	 ...
	 */
	public function run() {
		DB::table('news')->where('id', 23)->update([
		...
		DB::table('news')->where('id', 24)->update([
		...
		DB::table('news')->where('id', 25)->update([
		...
		DB::table('news')->where('id', 26)->update([
		...
		DB::table('news')->where('id', 27)->update([
		...
		DB::table('news')->where('id', 28)->update([
		...
		DB::table('news')->where('id', 29)->update([
		...
		DB::table('news')->where('id', 30)->update([
		...
		DB::table('news')->where('id', 31)->update([
